...
botonSubir.addEventListener("click", () => {
  ...
  if (inputFirstHF.value != "") {
    ...
    document.getElementById("firstHF").innerHTML =
      "Tu primera habilidad fuerte";
  }
  ...
  if (inputSecondHF.value != "") {
    ...
    document.getElementById("secondHF").innerHTML =
      "Tu segunda habilidad fuerte";
  }
  ...
  if (inputFirstHB.value != "") {
    ...
    document.getElementById("firstHB").innerHTML =
      "Tu primera habilidad blanda";
  }
  ...
  if (inputSecondHB.value != "") {
    ...
    document.getElementById("secondHB").innerHTML =
      "Tu segunda habilidad blanda";
  }
